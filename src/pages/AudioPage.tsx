...
import { ProductCard } from '../components/Audio/ProductCard';
import { Filters } from '../components/Audio/Filters';
import { mockProducts } from '../components/Audio/mockData';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-sm mb-6">
        <ul className="flex items-center space-x-2 text-slate-600 dark:text-slate-400">
          ...
          <li className="before:content-['/'] before:mx-2">Áudio</li>
