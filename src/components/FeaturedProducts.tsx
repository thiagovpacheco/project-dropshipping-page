      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <div className="flex flex-col items-center text-center mb-12">
            <h2 className="text-4xl sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-violet-600 dark:from-indigo-400 dark:to-violet-400 mb-4 tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
          {products.slice(0, 6).map((product) => (
            <div 
              ...
              className="group bg-white dark:bg-slate-800 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col border border-slate-100 dark:border-slate-700 min-h-[480px] w-full hover:scale-[1.02] cursor-pointer"
            >
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-4">
                    ...
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1.5
                              ...
                              hover:scale-[1.02]
                              min-w-[100px] sm:min-w-[120px] h-[38px]"
                    >
