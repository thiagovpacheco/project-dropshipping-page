...
export const categories = [
  ...
  { value: 'caixas', label: 'Caixas de Som' },
  { value: 'microfones', label: 'Microfones' },
...
export const Filters: React.FC<FiltersProps> = ({
  ...
  const handleDiscountRangeChange = (range: string) => {
    const newRanges = selectedDiscountRanges.includes(range)
      ? selectedDiscountRanges.filter(r => r !== range)
      : [...selectedDiscountRanges, range];
